...
import 'package:spdms_app/features/penalty/pages/tabs/cc_inbox_tab.dart';
import 'package:spdms_app/features/penalty/pages/tabs/my_requests_tab.dart';
...
class PenaltyRequestsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => PenaltyProvider(
        PenaltyService(context.read<AuthProvider>()),
      )..loadMyRequests()..loadCcInbox(),
      child: DefaultTabController(
        length: isCC ? 2 : 1,
        child: Scaffold(
          appBar: AppBar(
            title: const Text('Penalty Requests', style: TextStyle(fontWeight: FontWeight.bold)),
