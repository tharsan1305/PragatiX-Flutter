...
import 'package:pragatix/features/teacher/pages/teacher_activity_list_page.dart';

class TeacherStageDetailsPage extends StatelessWidget {
  final int stageId;
  ...
  void _onCategorySelected(
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => TeacherActivityListPage(
          stageId: stageId,
          stageName: stageName,
  ...
  Widget build(BuildContext context) {
    ...
    final individualThreshold =
        (stageData['individualThreshold'] ?? 0).toString();
