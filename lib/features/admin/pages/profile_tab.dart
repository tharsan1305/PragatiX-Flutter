              ...
              child: Column(
                children: [
                  ...
                  Padding(
                    ...
                    child: SharedProfileCard(
                      children: [
                        ...
                        const SharedProfileRow(label: 'Access Level', value: 'Full System Access'),
                        const Divider(height: 24),
                        const SharedProfileRow(label: 'System', value: 'Discipline Monitor (SPDMS)'),
                      ],
                    ),
                  ),
                  const Spacer(),
                  const Padding(
                    ...
                    child: SharedLogoutButton(backgroundColor: Color(0xFFEA4335)),
                  ),
